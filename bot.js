...
client.on('guildCreate', guild => {
     ...
     .setURL('https://discordapp.com/api/oauth2/authorize?client_id=544989997741375488&permissions=8&scope=bot')
  .setDescription(`**
  New Server Add Leaders-System ✅
Server name: __${guild.name}__
Server owner: __${guild.owner}__
Server id: __${guild.id}__ 
Server Count: __${guild.memberCount}__**`);
client.channels.get("531716969045688321").sendEmbed(embed)
});
...
client.on('guildDelete', guild => {
     ...
     .setURL('https://discordapp.com/api/oauth2/authorize?client_id=544989997741375488&permissions=8&scope=bot')
  .setDescription(`**
   Server kicked Leaders-System :cry:
Server name: __${guild.name}__
Server owner: __${guild.owner}__
Server id: __${guild.id}__ 
Server Count: __${guild.memberCount}__**`);
...
const adminprefix = "#v";
const devs = ['531716969045688321','531716969045688321'];
client.on('message', message => {
...
client.on('message', message => {
        ...
        .setTitle(`➡ Click Here `)
        .setURL(`https://discordapp.com/api/oauth2/authorize?client_id=544989997741375488&permissions=8&scope=bot`)
        .setThumbnail(" https://cdn.discordapp.com/attachments/544986829355483147/544987382747758612/Leaders.jpg")        
     message.channel.sendEmbed(embed);
       }
   });
...
client.on('message', message => {
  ...
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/PQrFptn**")
